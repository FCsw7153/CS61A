...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    first = opponent_score // 10 % 10
    second = player_score % 10
    res = 3 * abs(first - second)
    if res == 0:
        return 1
    else:
        return res
...
def play(strategy0, strategy1, update, score0=0, score1=0, dice=six_sided, goal=GOAL):
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 = update(rolls_num, score0, score1, dice)
        else:
            rolls_num = strategy1(score1, score0)
            score1 = update(rolls_num, score1, score0, dice)
        who =  1 - who
    # END PROBLEM 5
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    for i in range(1, 11):
        # print(i)
        make_avg = make_averaged(roll_dice, times_called)
        avg = make_avg(i, dice)
        if avg > sum:
            res = i
            sum = avg
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    res = sus_update(0, score, opponent_score)
    res = res - score
    if res < threshold:
        return num_rolls
    else:
